...
const {gif , loading , fetchData} = useGif(tag)
  ...
  return (
    <div className='w-1/2  bg-blue-500 h-max-[450px] rounded-lg border border-black flex flex-col items-center gap-y-5 mt-[15px]'>
...

    {
      ...
      <input 
      className='w-11/12 text-lg py-2 rounded-lg mb-[3px] px-1 text-center'
